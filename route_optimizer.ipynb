 ...
 "cells": [
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "2  Mazza Middle Eastern Cuisine  40.736701 -111.847827        1515 S 1500 E   \n",
      "6                Publik Kitchen  40.750042 -111.864259          931 E 900 S   \n",
      "1                 Banbury Cross  40.753749 -111.870710          705 S 700 E   \n",
      "7                          Buds  40.763001 -111.876332          509 E 300 S   \n",
      "8       Even Stevens Sandwiches  40.764636 -111.879047   200 South 414 East   \n",
      "5              The Copper Onion  40.762857 -111.887471  111 E Broadway #170   \n",
      ...
      "0          Murray    UT        84107  \n",
      "2  Salt Lake City    UT        84105  \n",
      "6  Salt Lake City    UT        84105  \n",
      "1  Salt Lake City    UT        84102  \n",
      "7  Salt Lake City    UT        84102  \n",
      "8  Salt Lake City    UT        84111  \n",
      "5  Salt Lake City    UT        84111  \n",
      "4  Salt Lake City    UT        84101  \n",
      "3  Salt Lake City    UT        84101  \n",
      "0          Murray    UT        84107  \n"
     ]
    }
   ],
   "source": [
    ...
    "    location = [0]\n",
    "    today_inspections = pd.DataFrame(data,\n",
    "                                     columns=['name', 'lat', 'lng', 'address', 'city', 'state', 'postal_code'],\n",
    "                                     index=location)\n",
    "\n",
    "    # Add a specified number of inspection_locations for today's inspections (normally done by due date)\n",
    "    num_inspections = 8\n",
    "    today_inspections = today_inspections.append(inspection_locations.sample(num_inspections,\n",
    "                                                                             random_state=123),\n",
    "                                                 ignore_index=True)\n",
    "\n",
    "    # Create distance matrix for today's inspections\n",
    "    distance_matrix =  pd.DataFrame(distance_matrix(today_inspections.loc[:,('lat','lng')].to_numpy(),\n",
    "                                                    today_inspections.loc[:,('lat','lng')].to_numpy()),\n",
    ...
    "    # print('Objective: {} miles'.format(solution.ObjectiveValue()))  # Need to adjust for scaled distance matrix\n",
